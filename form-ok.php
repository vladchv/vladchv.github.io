...
<body>
	<div class="main">
		...
		<p class="success">Проверьте пожалуйста введенный номер:</p>
		<p class="success current-phone" style="font-weight:bold;"></p>
		...
		<a href="/" class="shiny-button"><strong>Вернуться на сайт</strong></a>
    </div>
<script>
var tp = localStorage.getItem('current_form');
$('.current-phone').text(tp);
</script>
</body>
</html>